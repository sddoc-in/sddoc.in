...
import animationData from "@/public/lottie/anime1.json";
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Custom Automation Solutions" />
                    <List text="Data Science and Analytics" />
                    <List text="Full-Stack Development Services" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="API Development and Integration" />
                    <List text="CRM and ERP Solutions" />
                    <List text="Developer-Friendly Services" />
                  </div>
                </div>
              </div>
            </div>
